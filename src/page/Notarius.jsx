...
const Notarius = () => {
  ...
  return (
    ...
    <main class="">
      <section
        class=" w-full px-5 h-[30vh]  flex items-center justify-center
  bg-hero-pattern    bg-cover bg-center bg-no-repeat 
   "
      >
        {/* <SearchForn handleSearchInputChange={handleSearchInputChange} /> */}
        <SearchForn />
      </section>
      <section class="bg-white  min-h-[calc(100vh-200px)] w-full py-5">
        <Container>
          <div class="grid xl:grid-cols-[25%_1fr] gap-4 xl:gap-0 ">
            <div
              class={`  xl:block bg-white  lg:pt-5  ${
                isShownFilters
