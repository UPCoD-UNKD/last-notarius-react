  ...
  return (
    <div class="border__top  py-10 mt-10 mx-auto  lg:px-4  grid lg:grid-cols-[35%_1fr]">
      ...
      <div class="xl:flex gap-10 xl:items-end xl:ml-auto">
        <dl class="flex items-baseline p-4 py-1 bg-white   rounded-lg xl:min-w-[229px] border-2 border-slate-300">
          ...
          <dl class="mt-5 flex items-baseline p-4  py-1 bg-white border-2 border-slate-300 rounded-lg">
